...
import 'presentation/blocs/account_info/account_info_cubit.dart' as _i29;
import 'presentation/blocs/app_config/app_config_cubit.dart' as _i30;
...
import 'presentation/blocs/home/home_screen_cubit.dart' as _i19;
import 'presentation/blocs/login/login_cubit.dart' as _i20;
import 'presentation/blocs/profile/profile_cubit.dart' as _i21;
import 'presentation/blocs/register/register_cubit.dart' as _i22;
import 'presentation/blocs/reset_password/reset_password_cubit.dart' as _i23;
import 'presentation/blocs/splash/splash_cubit.dart' as _i24;
import 'presentation/blocs/trade/trade_cubit.dart' as _i25;
import 'presentation/blocs/trades/trades_cubit.dart' as _i26;
import 'presentation/blocs/transactions/transactions_cubit.dart' as _i27;
import 'presentation/blocs/verify_mobile/verify_mobile_cubit.dart' as _i28;
import 'service_locator.dart' as _i31; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i21.ProfileCubit>(() => _i21.ProfileCubit(
        appRepository: get<_i13.AppRepository>(),
        sharedPreferences: get<_i6.SharedPreferencesRepository>(),
      ));
  gh.factory<_i22.RegisterCubit>(
      () => _i22.RegisterCubit(get<_i13.AppRepository>()));
  gh.factory<_i23.ResetPasswordCubit>(
      () => _i23.ResetPasswordCubit(get<_i13.AppRepository>()));
  gh.factory<_i24.SplashCubit>(() => _i24.SplashCubit(
        appRepository: get<_i13.AppRepository>(),
        sharedPreferences: get<_i6.SharedPreferencesRepository>(),
      ));
  gh.factory<_i25.TradeCubit>(() => _i25.TradeCubit(
        appRepository: get<_i13.AppRepository>(),
        appNotificationEvents: get<_i9.Stream<_i8.AppNotificationEvent>>(),
        sharedPreferences: get<_i6.SharedPreferencesRepository>(),
      ));
  gh.factory<_i26.TradesCubit>(
      () => _i26.TradesCubit(get<_i13.AppRepository>()));
  gh.factory<_i27.TransactionsCubit>(
      () => _i27.TransactionsCubit(get<_i13.AppRepository>()));
  gh.factory<_i28.VerifyMobileCubit>(() => _i28.VerifyMobileCubit(
        appRepository: get<_i13.AppRepository>(),
        sharedPreferences: get<_i6.SharedPreferencesRepository>(),
      ));
  gh.factory<_i29.AccountInfoCubit>(
      () => _i29.AccountInfoCubit(get<_i13.AppRepository>()));
  gh.lazySingleton<_i30.AppConfigCubit>(() => _i30.AppConfigCubit(
        appRepository: get<_i13.AppRepository>(),
        sharedPreferences: get<_i6.SharedPreferencesRepository>(),
        appNotificationEvents: get<_i9.Stream<_i8.AppNotificationEvent>>(),
      ));
